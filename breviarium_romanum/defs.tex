...
\newcommand{\rubTemporePaschali}{%
  \rubrica{Tempore Paschali:}}

\newcommand{\utInBreviarioPraeter}{%
  \rubrica{Omnia ut in Antiphonario sub hac die, praeter sequentia.}}
\newcommand{\venitePaginaSandhofe}[1]{%
  \rubrica{Psalmus Venite: Nocturnale Romanum, pag. #1.}}
\newcommand{\perDominum}{Per Dóminum.}
\newcommand{\oratioSupra}{\rubrica{Oratio ut supra.}}
...
\newcommand{\tpAlleluia}{\rubrica{T. P.} Allelúja.}
...
\newcommand{\lacuna}[1]{%
  ...
  \begin{center}{\Large \textsc{Lacuna #1.}}\end{center}
  \vfill\clearpage{}}
